...
public class RolesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RolesPackage.ROLE_TO: {
				RoleTo roleTo = (RoleTo)theEObject;
				T result = caseRoleTo(roleTo);
				if (result == null) result = caseRole(roleTo);
				if (result == null) result = caseInterface(roleTo);
				if (result == null) result = caseGlue(roleTo);
				if (result == null) result = caseObjet(roleTo);
			...
			case RolesPackage.ROLE: {
				...
				if (result == null) result = caseGlue(role);
				if (result == null) result = caseObjet(role);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RolesPackage.ROLE_FROM: {
				RoleFrom roleFrom = (RoleFrom)theEObject;
				T result = caseRoleFrom(roleFrom);
				if (result == null) result = caseRole(roleFrom);
				if (result == null) result = caseInterface(roleFrom);
				if (result == null) result = caseGlue(roleFrom);
				if (result == null) result = caseObjet(roleFrom);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RolesPackage.GLUE: {
				Glue glue = (Glue)theEObject;
				T result = caseGlue(glue);
//removed				if (result == null) result = caseObjet(glue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
