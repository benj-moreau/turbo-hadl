...
public class InterfacesPackage extends EPackageImpl {
	 ...
	 * @ordered
	 */
	public static final int INTERFACE___NOTIFY_CONFIG = HADLPackage.OBJET_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	public static final int PORT___NOTIFY_CONFIG = INTERFACE___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int PORT_FOURNI_COMPO___NOTIFY_CONFIG = PORT___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int PORT_REQUIS_CONFIG___NOTIFY_CONFIG = PORT___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int SERVICE___NOTIFY_CONFIG = INTERFACE___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int SERVICE_REQUIS___NOTIFY_CONFIG = SERVICE___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int SERVICE_FOURNI___NOTIFY_CONFIG = SERVICE___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int PORT_FOURNI_CONFIG___NOTIFY_CONFIG = PORT___NOTIFY_CONFIG;
	 ...
	 * @ordered
	 */
	public static final int PORT_REQUIS_COMPO___NOTIFY_CONFIG = PORT___NOTIFY_CONFIG;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link hADL.Interfaces.Port#getObserver <em>Observer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the '{@link hADL.Interfaces.Interface#notifyConfig() <em>Notify Config</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Notify Config</em>' operation.
	 * @see hADL.Interfaces.Interface#notifyConfig()
	 * @generated
	 */
	public EOperation getInterface__NotifyConfig() {
	...
	public void createPackageContents() {
		...
		createEOperation(interfaceEClass, INTERFACE___NOTIFY_CONFIG);
	...
	public void initializePackageContents() {
		...
		initEReference(getPort_Observer(), theConfigurationPackage.getObserver(), null, "observer", null, 0, -1, Port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getInterface__NotifyConfig(), null, "notifyConfig", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	public interface Literals {
		 ...
		 * @generated
		 */
		public static final EOperation INTERFACE___NOTIFY_CONFIG = eINSTANCE.getInterface__NotifyConfig();
