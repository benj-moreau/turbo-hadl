/**
 */
package hADL.Configuration.util;
 ...
 * <!-- end-user-doc -->
 * @see hADL.Configuration.ConfigurationPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigurationPackage.CONFIGURATION: {
				...
				if (result == null) result = caseObserver(configuration);
				if (result == null) result = caseObjet(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.OBSERVER: {
				Observer observer = (Observer)theEObject;
				T result = caseObserver(observer);
				if (result == null) result = caseObjet(observer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
