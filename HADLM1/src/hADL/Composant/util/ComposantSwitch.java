 ...
 * @generated
 */
public class ComposantSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComposantPackage.COMPOSANT: {
				...
				if (result == null) result = caseObserver(composant);
				if (result == null) result = caseObjet(composant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComposantPackage.CONTRAINTES: {
				Contraintes contraintes = (Contraintes)theEObject;
				T result = caseContraintes(contraintes);
				if (result == null) result = caseObjet(contraintes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComposantPackage.PROPRIETE_NON_FONC: {
				ProprieteNonFonc proprieteNonFonc = (ProprieteNonFonc)theEObject;
				T result = caseProprieteNonFonc(proprieteNonFonc);
				if (result == null) result = casePropriete(proprieteNonFonc);
				if (result == null) result = caseObjet(proprieteNonFonc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComposantPackage.PROPRIETE: {
				Propriete propriete = (Propriete)theEObject;
				T result = casePropriete(propriete);
				if (result == null) result = caseObjet(propriete);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComposantPackage.PROPRIETE_FONC: {
				ProprieteFonc proprieteFonc = (ProprieteFonc)theEObject;
				T result = caseProprieteFonc(proprieteFonc);
				if (result == null) result = casePropriete(proprieteFonc);
				if (result == null) result = caseObjet(proprieteFonc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Propriete Non Fonc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Propriete Non Fonc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProprieteNonFonc(ProprieteNonFonc object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Propriete Fonc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Propriete Fonc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProprieteFonc(ProprieteFonc object) {
		return null;
	}
