...
public class RolesPackage extends EPackageImpl {
	 ...
	 * @ordered
	 */
	public static final int ROLE___NOTIFY_CONFIG__OBJECT = InterfacesPackage.INTERFACE___NOTIFY_CONFIG__OBJECT;
	 ...
	 * @ordered
	 */
	public static final int ROLE_TO___NOTIFY_CONFIG__OBJECT = ROLE___NOTIFY_CONFIG__OBJECT;
	 ...
	 * @ordered
	 */
	public static final int ROLE_FROM___NOTIFY_CONFIG__OBJECT = ROLE___NOTIFY_CONFIG__OBJECT;
	...
	private RolesPackage() {
		super(eNS_URI, RolesFactory.INSTANCE);
	}
	...
	/**
	 * Returns the meta object for the containment reference '{@link hADL.Roles.Role#getObserver <em>Observer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void initializePackageContents() {
		...
		initEReference(getRole_Observer(), theConfigurationPackage.getObserver(), null, "observer", null, 1, 1, Role.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
