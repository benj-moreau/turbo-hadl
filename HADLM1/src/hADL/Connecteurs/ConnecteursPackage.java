...
public class ConnecteursPackage extends EPackageImpl {
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR__CHILD_CONFIGURATION = HADLPackage.ELEMENT__CHILD_CONFIGURATION;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR__CHILD_COMPOSANT = HADLPackage.ELEMENT__CHILD_COMPOSANT;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR__CHILD_CONNECTEUR = HADLPackage.ELEMENT__CHILD_CONNECTEUR;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR__ROLEFROM = HADLPackage.ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR__ROLETO = HADLPackage.ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_FEATURE_COUNT = HADLPackage.ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_IMPLICITE__CHILD_CONFIGURATION = CONNECTEUR__CHILD_CONFIGURATION;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_IMPLICITE__CHILD_COMPOSANT = CONNECTEUR__CHILD_COMPOSANT;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_IMPLICITE__CHILD_CONNECTEUR = CONNECTEUR__CHILD_CONNECTEUR;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_IMPLICITE__ROLEFROM = CONNECTEUR__ROLEFROM;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_IMPLICITE__ROLETO = CONNECTEUR__ROLETO;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_ENUMERE__CHILD_CONFIGURATION = CONNECTEUR__CHILD_CONFIGURATION;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_ENUMERE__CHILD_COMPOSANT = CONNECTEUR__CHILD_COMPOSANT;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_ENUMERE__CHILD_CONNECTEUR = CONNECTEUR__CHILD_CONNECTEUR;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_ENUMERE__ROLEFROM = CONNECTEUR__ROLEFROM;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_ENUMERE__ROLETO = CONNECTEUR__ROLETO;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_EXPLICITE__CHILD_CONFIGURATION = CONNECTEUR__CHILD_CONFIGURATION;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_EXPLICITE__CHILD_COMPOSANT = CONNECTEUR__CHILD_COMPOSANT;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_EXPLICITE__CHILD_CONNECTEUR = CONNECTEUR__CHILD_CONNECTEUR;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_EXPLICITE__ROLEFROM = CONNECTEUR__ROLEFROM;
	 ...
	 * @ordered
	 */
	public static final int CONNECTEUR_EXPLICITE__ROLETO = CONNECTEUR__ROLETO;
	...
	private ConnecteursPackage() {
		super(eNS_URI, ConnecteursFactory.INSTANCE);
	}
	...
	/**
	 * Returns the meta object for the containment reference list '{@link hADL.Connecteurs.Connecteur#getRolefromList <em>Rolefrom</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Rolefrom</em>'.
	 * @see hADL.Connecteurs.Connecteur#getRolefromList()
	 * @see #getConnecteur()
	 * @generated
	 */
	public EReference getConnecteur_Rolefrom() {
		return (EReference)connecteurEClass.getEStructuralFeatures().get(0);
	}


	/**
	 * Returns the meta object for the containment reference list '{@link hADL.Connecteurs.Connecteur#getRoletoList <em>Roleto</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Roleto</em>'.
	 * @see hADL.Connecteurs.Connecteur#getRoletoList()
	 * @see #getConnecteur()
	 * @generated
	 */
	public EReference getConnecteur_Roleto() {
	...
	public void createPackageContents() {
		...
		createEReference(connecteurEClass, CONNECTEUR__ROLEFROM);
		createEReference(connecteurEClass, CONNECTEUR__ROLETO);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getConnecteur_Rolefrom(), theRolesPackage.getRoleFrom(), null, "rolefrom", null, 0, -1, Connecteur.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConnecteur_Roleto(), theRolesPackage.getRoleTo(), null, "roleto", null, 0, -1, Connecteur.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
	...
	public interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Rolefrom</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		public static final EReference CONNECTEUR__ROLEFROM = eINSTANCE.getConnecteur_Rolefrom();

		/**
		 * The meta object literal for the '<em><b>Roleto</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		public static final EReference CONNECTEUR__ROLETO = eINSTANCE.getConnecteur_Roleto();
